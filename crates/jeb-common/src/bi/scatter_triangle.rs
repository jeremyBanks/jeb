...
mod tests {
    ...
    proptest! {
        ...
        fn prop_shell_monotonic_u16(u in 1u16..32640u16) {
            let (x1, y1): (i8, i8) = scatter_triangle(u - 1);
            let (x2, y2): (i8, i8) = scatter_triangle(u);
        ...
        fn prop_roundtrip_u32_sample(idx in 0u32..100000u32) {
            let (x, y): (i16, i16) = scatter_triangle(idx);
        ...
        #[test]
        fn prop_roundtrip_u64_sample(idx in 0u64..100000u64) {
            let (x, y): (i32, i32) = scatter_triangle(idx);
            let back: u64 = scatter_triangle((x, y));
            prop_assert_eq!(idx, back, "roundtrip failed for u64 {}", idx);
        }
    }
