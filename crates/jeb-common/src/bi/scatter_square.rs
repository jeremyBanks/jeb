...
mod tests {
    ...
    proptest! {
        ...
        fn prop_shell_monotonic_u16(u in 0u16..65025u16) {
            ...
            let (x1, y1): (i8, i8) = scatter_square(u - 1);
            let (x2, y2): (i8, i8) = scatter_square(u);
    ...
    fn bijection_coverage_u16() {
        ...
        for u in 0u16..=u16::MAX {
            let pair: (i8, i8) = scatter_square(u);
