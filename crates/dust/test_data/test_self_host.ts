...
// Usage: deno run test_self_host.ts

const selfHostWasm = await Deno.readFile("crates/dust/examples/self_host.wasm");
...
const compiler = compilerModule.instance.exports as any;
...
try {
  ...
  const testExports = testModule.instance.exports as any;
