...
floating-point numbers (excluding NaN or Infinity, including -0), arrays of
arbitrary values, and order-preserving maps with text string keys and arbitrary
values. This adds signed and unsigned 64-bit integers, binary byte strings, and
order-preserving maps with binary byte string keys and arbitrary values.
