...
pub const UTF8_LUT: [u8; 256] = OBS(UTF8).index_lut();
...
pub const ASCII_LUT: [u8; 256] = OBS(ASCII).index_lut();
...
pub const ASCII_TEXT: &[u8; 97] = &OBS(ASCII)
    ...
    .to_array();
pub const ASCII_TEXT_LUT: [u8; 256] = OBS(UTF8_TEXT).index_lut();
...
pub const UTF8_TEXT: &[u8; 212] = &OBS(UTF8)
    .sub(OBS(ASCII_NON_WHITESPACE_CONTROL_CHARACTERS))
    .to_array();
pub const UTF8_TEXT_LUT: [u8; 256] = OBS(UTF8_TEXT).index_lut();
