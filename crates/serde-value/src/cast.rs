...
//!
//! This module provides [`try_cast`], which converts between types that
//! implement serde's `Serialize` and `Deserialize` traits by going through
...
/// as the target type. This allows converting between types that have
/// compatible serde representations.
///
/// # Example
///
/// ```
