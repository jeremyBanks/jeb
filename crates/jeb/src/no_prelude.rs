...
#![cfg_attr(feature = "clobber_language_prelude", no_implicit_prelude)]
// pub use crate::clobber_language_prelude::*;

// The language prelude can not be disabled with `#![no_implicit_prelude]`, but
// we can export useless placeholders to clobber everything in it.
//
