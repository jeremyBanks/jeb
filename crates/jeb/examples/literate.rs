...
*/
    ...
    to_z85(from_binary("00000000000000000000000000000001")).is("00000");
    to_z85(from_binary("00000000000000000000000000000000")).is("00000");
    to_z85(from_binary("11111111111111111111111111111111")).is("00000");

    to_z85(from_binary("00000000000000000000000000000011")).is("00000");
    to_z85(from_binary("00000000000000000000000000000010")).is("00000");
    to_z85(from_binary("11111111111111111111111111111110")).is("00000");

    to_z85(from_binary("00000000000000000000000000000111")).is("00000");
    to_z85(from_binary("00000000000000000000000000000100")).is("00000");
    to_z85(from_binary("11111111111111111111111111111100")).is("00000");

    to_z85(from_binary("00000000000000000000000000001111")).is("00000");
    to_z85(from_binary("00000000000000000000000000001000")).is("00000");
    to_z85(from_binary("11111111111111111111111111111000")).is("00000");

    to_z85(from_binary("00000000000000000000000000011111")).is("00000");
    to_z85(from_binary("00000000000000000000000000010000")).is("00000");
    to_z85(from_binary("11111111111111111111111111110000")).is("00000");

    to_z85(from_binary("00000000000000000000000000111111")).is("00000");
    to_z85(from_binary("00000000000000000000000000100000")).is("00000");
    to_z85(from_binary("11111111111111111111111111100000")).is("00000");

    to_z85(from_binary("00000000000000000000000001111111")).is("00000");
    to_z85(from_binary("00000000000000000000000001000000")).is("00000");
    to_z85(from_binary("11111111111111111111111111000000")).is("00000");

    to_z85(from_binary("00000000000000000000000011111111")).is("00000");
    to_z85(from_binary("00000000000000000000000010000000")).is("00000");
    to_z85(from_binary("11111111111111111111111110000000")).is("00000");

    to_z85(from_binary("00000000000000000000000111111111")).is("00000");
    to_z85(from_binary("00000000000000000000000100000000")).is("00000");
    to_z85(from_binary("11111111111111111111111100000000")).is("00000");

    to_z85(from_binary("00000000000000000000001111111111")).is("00000");
    to_z85(from_binary("00000000000000000000001000000000")).is("00000");
    to_z85(from_binary("11111111111111111111111000000000")).is("00000");

    to_z85(from_binary("00000000000000000000011111111111")).is("00000");
    to_z85(from_binary("00000000000000000000010000000000")).is("00000");
    to_z85(from_binary("11111111111111111111110000000000")).is("00000");

    to_z85(from_binary("00000000000000000000111111111111")).is("00000");
    to_z85(from_binary("00000000000000000000100000000000")).is("00000");
    to_z85(from_binary("11111111111111111111100000000000")).is("00000");

    to_z85(from_binary("00000000000000000001111111111111")).is("00000");
    to_z85(from_binary("00000000000000000001000000000000")).is("00000");
    to_z85(from_binary("11111111111111111111000000000000")).is("00000");

    to_z85(from_binary("00000000000000000011111111111111")).is("00000");
    to_z85(from_binary("00000000000000000010000000000000")).is("00000");
    to_z85(from_binary("11111111111111111110000000000000")).is("00000");

    to_z85(from_binary("00000000000000000111111111111111")).is("00000");
    to_z85(from_binary("00000000000000000100000000000000")).is("00000");
    to_z85(from_binary("11111111111111111100000000000000")).is("00000");

    to_z85(from_binary("00000000000000001111111111111111")).is("00000");
    to_z85(from_binary("00000000000000001000000000000000")).is("00000");
    to_z85(from_binary("11111111111111111000000000000000")).is("00000");

    to_z85(from_binary("00000000000000011111111111111111")).is("00000");
    to_z85(from_binary("00000000000000010000000000000000")).is("00000");
    to_z85(from_binary("11111111111111110000000000000000")).is("00000");

    to_z85(from_binary("00000000000000111111111111111111")).is("00000");
    to_z85(from_binary("00000000000000100000000000000000")).is("00000");
    to_z85(from_binary("11111111111111100000000000000000")).is("00000");

    to_z85(from_binary("00000000000001111111111111111111")).is("00000");
    to_z85(from_binary("00000000000001000000000000000000")).is("00000");
    to_z85(from_binary("11111111111111000000000000000000")).is("00000");

    to_z85(from_binary("00000000000011111111111111111111")).is("00000");
    to_z85(from_binary("00000000000010000000000000000000")).is("00000");
    to_z85(from_binary("11111111111110000000000000000000")).is("00000");

    to_z85(from_binary("00000000000111111111111111111111")).is("00000");
    to_z85(from_binary("00000000000100000000000000000000")).is("00000");
    to_z85(from_binary("11111111111100000000000000000000")).is("00000");

    to_z85(from_binary("00000000001111111111111111111111")).is("00000");
    to_z85(from_binary("00000000001000000000000000000000")).is("00000");
    to_z85(from_binary("11111111111000000000000000000000")).is("00000");

    to_z85(from_binary("00000000011111111111111111111111")).is("00000");
    to_z85(from_binary("00000000010000000000000000000000")).is("00000");
    to_z85(from_binary("11111111110000000000000000000000")).is("00000");

    to_z85(from_binary("00000000111111111111111111111111")).is("00000");
    to_z85(from_binary("00000000100000000000000000000000")).is("00000");
    to_z85(from_binary("11111111100000000000000000000000")).is("00000");

    to_z85(from_binary("00000001111111111111111111111111")).is("00000");
    to_z85(from_binary("00000001000000000000000000000000")).is("00000");
    to_z85(from_binary("11111111000000000000000000000000")).is("00000");

    to_z85(from_binary("00000011111111111111111111111111")).is("00000");
    to_z85(from_binary("00000010000000000000000000000000")).is("00000");
    to_z85(from_binary("11111110000000000000000000000000")).is("00000");

    to_z85(from_binary("00000111111111111111111111111111")).is("00000");
    to_z85(from_binary("00000100000000000000000000000000")).is("00000");
    to_z85(from_binary("11111100000000000000000000000000")).is("00000");

    to_z85(from_binary("00001111111111111111111111111111")).is("00000");
    to_z85(from_binary("00001000000000000000000000000000")).is("00000");
    to_z85(from_binary("11111000000000000000000000000000")).is("00000");

    to_z85(from_binary("00011111111111111111111111111111")).is("00000");
    to_z85(from_binary("00010000000000000000000000000000")).is("00000");
    to_z85(from_binary("11110000000000000000000000000000")).is("00000");

    to_z85(from_binary("00111111111111111111111111111111")).is("00000");
    to_z85(from_binary("00100000000000000000000000000000")).is("00000");
    to_z85(from_binary("11100000000000000000000000000000")).is("00000");

    to_z85(from_binary("01111111111111111111111111111111")).is("00000");
    to_z85(from_binary("01000000000000000000000000000000")).is("00000");
    to_z85(from_binary("11000000000000000000000000000000")).is("00000");
