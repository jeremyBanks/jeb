...
*/
    ...
    to_z85(from_binary(                        "00000011")).is(   "0@");
    ...
    to_z85(from_binary(                        "00000111")).is(   "2l");
    ...
    to_z85(from_binary(                        "00001111")).is(   "4/");
    ...
    to_z85(from_binary(                        "00011111")).is(   "9@");
    ...
    to_z85(from_binary(                        "00111111")).is(   "kl");
    ...
    to_z85(from_binary(                        "01111111")).is(   "E/");
    ...
    to_z85(from_binary(                        "11111111")).is(   "@@");
    ...
    to_z85(from_binary(                "0000000111111111")).is(  "0SJ");
    ...
    to_z85(from_binary(                "0000001111111111")).is(  "1oe");
    ...
    to_z85(from_binary(                "0000011111111111")).is(  "2MB");
    ...
    to_z85(from_binary(                "0000111111111111")).is(  "5b#");
    ...
    to_z85(from_binary(                "0001111111111111")).is(  "ao8");
    ...
    to_z85(from_binary(                "0011111111111111")).is(  "kMp");
    ...
    to_z85(from_binary(                "0111111111111111")).is(  "FbY");
    ...
    to_z85(from_binary(                "1111111111111111")).is(  "%nJ");
    ...
    to_z85(from_binary(        "000000011111111111111111")).is( "0SSf");
    ...
    to_z85(from_binary(        "000000111111111111111111")).is( "1onx");
    ...
    to_z85(from_binary(        "000001111111111111111111")).is( "2MK/");
    ...
    to_z85(from_binary(        "000011111111111111111111")).is( "5c8U");
    ...
    to_z85(from_binary(        "000111111111111111111111")).is( "aohu");
    ...
    to_z85(from_binary(        "001111111111111111111111")).is( "kMy-");
    ...
    to_z85(from_binary(        "011111111111111111111111")).is( "Fb/J");
    ...
    to_z85(from_binary(        "111111111111111111111111")).is( "%nS9");
