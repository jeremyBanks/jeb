...
This was a little rocky, including hitting a new compiler crash where I should
have had an error message (see
[rust#51798](https://github.com/rust-lang/rust/issues/51798)), but it's nicer,
and I took the oppertunity to break the code into a few distinct packages, and
add a few doc tests, and enable Travis. Giving me these badges:
...
I haven't made any emulator progress, but it was nice to play with this part of
Rust's tooling, and to be on the 2018 path.
