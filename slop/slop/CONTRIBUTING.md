...
1. Run `./scripts/new-version.sh` to generate a new version based on current
   date/time
2. This will update the version in `Cargo.toml` to format:
   0.0.0-vibes-YYYY-MM-DD.xxxx
3. Commit the change
