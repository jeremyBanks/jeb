...
=255,F=0xFFFFFFFF,B=v=>[v>>>24&M,v>>>16&M,v>>>8&M,v&M],C=String.fromCharCode,U=Uint8Array,D=[],K=s=>s.charCodeAt(),H=new Set([...Z+",;|~_"].
map(c=>K(c))),$=a=>a.reduce((p,x)=>p*E+x,0),T=TypeError,Q=z=>{throw new T};for(let j=E;j--;)D[K(Z[j])]=j